...
angular.module('xeditable').factory('editableController', 
  ...
  function EditableController($scope, $attrs, $element, $parse, editableThemes, editableOptions, $rootScope, $compile, $q) {
    ...
    self.render = function() {
	  ...
	  if($attrs.toggleVal && jQuery.fn.toggleVal){
		  self.editorEl.find('input').attr('placeholder', $attrs.toggleVal).toggleVal({populateFrom: 'custom', text: $attrs.toggleVal});
	  }
	  
	   //console.log(self.editorEl);
